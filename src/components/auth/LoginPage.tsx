...
// import {  handleGoogleAuth, login } from "../../api";
...
//   //   setError("");
//   //   try {
//   //     const result = await handleGoogleAuth(); // { type, user_id, name, email }
//   //     localStorage.setItem("userId", result.user_id);
//   //     updateUser({ user_id: result.user_id, name: result.name, email: result.email });

//   //     if (result.type === "signup") {
//   //       // New Google user → Redirect to Signup with prefilled details
//   //       navigate("/signup", { state: { name: result.name, email: result.email } });
//   //     } else {
//   //       // Existing Google user → Go directly to chat
//   //       navigate("/chat");
//   //     }
//   //   } catch (err: any) {
...
//       // result = { type: "login" | "signup", user_id, name, email }
