...
const OpsDashboard: React.FC = () => {
  const { tickets, updateTicketStatus } = useChat();
  const { user } = useAuth();
          ...
          <div className="bg-slate-800/50 backdrop-blur-lg border border-slate-700 rounded-lg p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-semibold text-white">{statusCounts.new}</p>
              </div>
          ...
          <div className="bg-slate-800/50 backdrop-blur-lg border border-slate-700 rounded-lg p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-semibold text-white">{statusCounts.in_progress}</p>
              </div>
          ...
          <div className="bg-slate-800/50 backdrop-blur-lg border border-slate-700 rounded-lg p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-semibold text-white">{statusCounts.completed}</p>
              </div>
        ...
        {filteredTickets.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-slate-400">
              {searchTerm ? 'Try adjusting your search terms' : 'New client requests will appear here'}
            </p>
          </div>
        )}
      </div>
