...
const TicketDetailsModal: React.FC<Props> = ({ ticket, onClose, onUpdate }) => {
  ...
  return (
    <div className="fixed inset-0 z-40 flex justify-end">
      ...
      />
      <div
        className={`relative z-50 w-full max-w-xl bg-slate-900 text-white h-full shadow-lg transition-transform duration-300 transform ${
        ...
        <div className="bg-slate-800/50 backdrop-blur-lg border border-slate-700 rounded-lg p-4 mb-0">
          ...
          {expandedSections.has("ticket_progress") ? (
            <div className="mt-2 max-h-96 overflow-y-auto">
              <TicketProgress ticket={ticketData} hideHeader={true} disableInternalScroll={true} onUpdate={onUpdate} />
            </div>
          ) : (
            <div className="text-slate-400 text-sm mt-2">
