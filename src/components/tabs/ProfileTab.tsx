...
//     { id: '1', action: 'Booked private jet to Aspen', time: '2 hours ago', status: 'completed' },
//     { id: '2', action: 'Reserved table at Le Bernardin', time: '1 day ago', status: 'completed' },
//     { id: '3', action: 'Arranged yacht charter in Monaco', time: '3 days ago', status: 'completed' },
//     { id: '4', action: 'Scheduled wellness retreat', time: '1 week ago', status: 'in_progress' }
//   ];
